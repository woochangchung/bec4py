...
def spdf_jackknife(x_arr,y_arr):
    """
    Uses jackknifing method to calculate unbiased estimate of SPDF mean and variance

    x_arr: array of x variable (e.g. lattice depth) 
    y_arr: array of y variable (e.g. ncount) with shape (num_images,3)
    """
